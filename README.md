[![Stars](https://img.shields.io/github/stars/RanaAhmar/developer-resume-latex?style=for-the-badge)](https://github.com/RanaAhmar/developer-resume-latex/stargazers) [![Issues](https://img.shields.io/github/issues/RanaAhmar/developer-resume-latex?style=for-the-badge)](https://github.com/RanaAhmar/developer-resume-latex/issues) [![MIT License](https://img.shields.io/badge/License-MIT-green.svg?style=for-the-badge)](https://github.com/RanaAhmar/developer-resume-latex/blob/main/LICENSE)

# developer-resume-latex

Professional, ATS-friendly LaTeX resume templates for software engineers.
...
## 📦 Installation
```bash
git clone https://github.com/RanaAhmar/developer-resume-latex.git
```
